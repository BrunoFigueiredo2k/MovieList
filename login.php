    ...
    <head>
        ...
        <script>
            ...
            function checkLoginCredentials() {
                ...
                $.post('php/authentification/checkLoginCredentials.php', {username:username, password:password}, function(response){
            ...
            function createNewUser() {
                ...
                $.post('php/authentification/createUser.php',{username:username, password:password}, function(response){
                    $('.databaseresponse').replaceWith(response);
                });
            }
        </script>
